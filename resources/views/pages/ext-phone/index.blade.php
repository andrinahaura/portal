    ...
    <div class="col-lg-12 position-relative z-index-2">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <form id="filterForm" method="GET" action="{{ route('extphone.index') }}">
                        ...
                        <select class="form-control" name="department" id="choices-department" onchange="submitForm()">
                    ...
                    <div class="col-sm-6">
                      <form action="">
                        ...
                        <div class="input-group">
                          <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
                          <input id="searchInput" class="form-control" type="text" placeholder="Find User">
                        </div>
                      </form>
                    </div>
      ...
      <ul id="itemList">
        ...
        <div class="row mt-4" id="phoneContainer">
          ...
          <div class="col-5th col-md-4 col-6 mt-sm-0 mt-4 phone-item">
            <div class="card mb-4">
